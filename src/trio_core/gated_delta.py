"""Gated Delta update — inlined from mlx_lm.models.gated_delta.

Metal kernel for DeltaNet hybrid attention (Qwen3.5). Self-contained,
only depends on mlx.core and mlx.nn.
"""
...
_gated_delta_kernel_vec_masked = _make_gated_delta_kernel(has_mask=True, vectorized=True)
